...
export const createCategory = (formData) => API.post('/netflix/category', formData);
...
export const dislikeItem = (formData) => API.put('/netflix/item/dislike',formData);
...
export const downloadItem = (formData) => API.put('/netflix/item/download',formData);
